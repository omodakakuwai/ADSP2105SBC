...
ADSP2105SBC consists of a Main board and a Sub board, which are connected to each other with two 26-pin flat cables.<br>
The Sub board has three EPROMs and the Main board has all other necessary devices.
